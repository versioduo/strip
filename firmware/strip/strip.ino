...
namespace {
  V2Device::Info     Info{V2DeviceInfo("com.versioduo.strip", 19, "versioduo:samd:strip")};
  V2LED::WS2812<2>   LED(PIN_LED_WS2812, sercom2, SPI_PAD_0_SCK_1, PIO_SERCOM);
  V2LED::WS2812<128> LEDExt(PIN_LED_WS2812_EXT, sercom1, SPI_PAD_0_SCK_1, PIO_SERCOM);
